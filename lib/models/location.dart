...
class Location {
  ...
  factory Location.fromJson(Map<String, Object?> json) => LocationfromJson(json);
  factory Location.fromSnapshot(DocumentSnapshot snapshot) => LocationfromSnapshot(snapshot);
