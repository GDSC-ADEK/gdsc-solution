...
class Fdatabase {
  final CollectionReference LocTypes = FirebaseFirestore.instance.collection('LocationTypes');
  final CollectionReference locs = FirebaseFirestore.instance.collection('Locations');
  final CollectionReference roles = FirebaseFirestore.instance.collection('Roles');
